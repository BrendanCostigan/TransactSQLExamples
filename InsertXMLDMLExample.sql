...
SET @myDoc.modify('insert <Maintenance>3 year parts and labor extended maintenance is available</Maintenance> 
...
SET @myDoc.modify('insert <Material>Aluminium</Material>        
